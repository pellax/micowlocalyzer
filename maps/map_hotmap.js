...
function getPoints() {
  ...
  let MarkerArray = [ {location:{lat: 41.1189, lng: 1.2445}, 
      content: '<h2>Numero de matricula:1234</h2>'},

      {location:{lat: 41.9794, lng: 2.8214}, content: '<h2>Numero de matricula:5678</h2>'},

      {location:{lat: 41.3851, lng: 2.1734},content: '<h2>Numero de matricula:1357</h2>' }]
